...
export const PIPELINE_STAGES = [
  { name: "Build",    icon: "📦", status: "success", duration: "42s",    steps: ["Install deps", "Compile TypeScript", "Bundle assets", "Optimize images"] },
  { name: "Test",     icon: "🧪", status: "success", duration: "1m 12s", steps: ["Unit tests (148/148)", "Integration tests", "Coverage: 89%", "Lint checks"] },
  { name: "Security", icon: "🔒", status: "warning", duration: "28s",    steps: ["SAST scan", "Dependency audit", "2 low severity", "Container scan"] },
  { name: "Deploy",   icon: "🚀", status: "running", duration: "38s",    steps: ["Push to registry", "Update deployment", "Health check", "DNS propagation"] },
];
...
export const EVALUATION_SCORES: Record<string, {
  ...
  "ml-pipeline":     { overall: "C",  quality: 58, coverage: 32, security: 61, perf: 55, maintain: 50, recs: ["Critical: add unit tests (32% coverage)", "Upgrade Python 3.9 → 3.12", "Add type annotations throughout codebase", "Remove hardcoded credentials from config.py"] },
};
