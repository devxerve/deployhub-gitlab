...
const ENTRIES: Entry[] = [
  ...
  [
    ...
    "A mini PaaS to connect Git repositories, deploy Dockerized applications and monitor them in real time.",
    "Un mini PaaS para conectar repositorios Git, desplegar aplicaciones Dockerizadas y monitorizarlas en tiempo real.",
    "Un mini PaaS pour connecter des dépôts Git, déployer des applications Dockerisées et les surveiller en temps réel.",
  ],
  [
    "settings.about.f1",
  ...
  [
    "settings.about.f2",
    "Real-time deployment logs and status over WebSockets, plus notifications about your deployment events — no page refresh needed.",
    "Logs y estado de los despliegues en vivo por WebSockets, además de notificaciones sobre tus eventos de despliegue — sin necesidad de recargar la página.",
    "Journaux et statut des déploiements en direct via WebSockets, ainsi que des notifications sur vos événements de déploiement — sans recharger la page.",
  ],
  [
    "settings.about.f3",
    "Sign in with email/password, Google, GitHub or 42 Intra — every account only ever sees its own projects and deployments, with role-based permissions.",
    "Inicia sesión con email/contraseña, Google, GitHub o 42 Intra — cada cuenta solo ve sus propios proyectos y despliegues, con permisos basados en roles.",
    "Connectez-vous avec e-mail/mot de passe, Google, GitHub ou 42 Intra — chaque compte ne voit que ses propres projets et déploiements, avec des permissions basées sur les rôles.",
  ],
  [
    "settings.about.f4",
    "Advanced log search and filtering with CSV export, plus an analytics dashboard with real-time charts for deployment success rates, build duration and resource usage.",
    "Búsqueda y filtrado avanzado de logs con exportación a CSV, además de un panel de analítica con gráficos en tiempo real de tasas de éxito, duración de builds y uso de recursos.",
    "Recherche et filtrage avancés des journaux avec export CSV, ainsi qu'un tableau de bord d'analyse avec des graphiques en temps réel des taux de réussite, de la durée des builds et de l'utilisation des ressources.",
  ],
  [
    "settings.about.f5",
    "Infrastructure monitoring with Prometheus, Grafana and cAdvisor, secured behind Traefik HTTPS and a ModSecurity/OWASP web application firewall.",
    "Monitorización de infraestructura con Prometheus, Grafana y cAdvisor, protegida detrás de Traefik HTTPS y un firewall de aplicaciones web ModSecurity/OWASP.",
    "Supervision de l'infrastructure avec Prometheus, Grafana et cAdvisor, sécurisée derrière Traefik HTTPS et un pare-feu applicatif ModSecurity/OWASP.",
  ],
  [
    "settings.about.f6",
    "Available in English, Spanish and French, with a responsive interface and dark/light themes.",
    "Disponible en inglés, español y francés, con una interfaz responsive y temas claro/oscuro.",
    "Disponible en anglais, espagnol et français, avec une interface responsive et des thèmes clair/sombre.",
  ],
  [
    "settings.about.stack",
    "Built with Next.js, NestJS split into microservices, PostgreSQL/Prisma and Docker, served behind Traefik with a ModSecurity WAF.",
    "Construido con Next.js, NestJS dividido en microservicios, PostgreSQL/Prisma y Docker, servido detrás de Traefik con un WAF ModSecurity.",
    "Construit avec Next.js, NestJS divisé en microservices, PostgreSQL/Prisma et Docker, servi derrière Traefik avec un WAF ModSecurity.",
  ],
