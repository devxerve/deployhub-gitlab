    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
        <input
          ...
          style={{ flex: 1, minWidth: 200, padding: "10px 14px", borderRadius: 10, border: `1px solid ${t.border}`, background: t.inputBg, color: t.text, fontSize: 13, outline: "none", fontFamily: "inherit" }}
        />
        ...
        <button onClick={exportLogs} style={{ padding: "10px 14px", borderRadius: 10, background: t.hover, border: `1px solid ${t.border}`, color: t.text, fontSize: 12, cursor: "pointer", fontFamily: "inherit" }}>
          📥 Export CSV
        </button>
      </div>
